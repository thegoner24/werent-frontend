...
const FooterLink: React.FC<FooterLinkProps> = ({ href, children }) => {
  return (
    <Link 
      href={href} 
      className="text-gray-600 hover:text-[#1b3cfe] transition-all duration-300 text-sm flex items-center group"
    >
    ...
    <div className="mb-8 md:mb-0">
      <h3 className="font-semibold text-gray-800 mb-5 text-lg">
        <span className="relative">
          {title}
          <span className="absolute -bottom-1 left-0 w-8 h-0.5 bg-gradient-to-r from-[#1b3cfe] to-[#1b3cfe]/90"></span>
        </span>
      </h3>
          ...
          <div className="mb-8 md:mb-0">
            <Link href="/" className="flex items-center mb-6">
              <span className="text-3xl font-bold">
                <span className="bg-gradient-to-r from-[#1b3cfe] to-[#1b3cfe]/90 bg-clip-text text-transparent">Cam</span>
            ...
            <div className="flex space-x-4">
              <a href="#" className="bg-white p-2.5 rounded-full shadow-sm border border-gray-100 text-gray-500 hover:text-[#1b3cfe] hover:shadow-md transition-all duration-300 group">
        ...
        <div className="mt-12 pt-8 border-t border-gray-200">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex space-x-6">
              <a href="#" className="text-gray-600 hover:text-[#1b3cfe] text-sm transition-colors duration-300">Privacy Policy</a>
              <a href="#" className="text-gray-600 hover:text-[#1b3cfe] text-sm transition-colors duration-300">Terms of Service</a>
              <a href="#" className="text-gray-600 hover:text-[#1b3cfe] text-sm transition-colors duration-300">Sitemap</a>
            </div>
          </div>
        </div>
      </Container>
