...
export default function Solution() {
  return (
    <section className="w-full py-20 bg-gradient-to-b from-white to-[#1b3cfe]/10">
      <Container>
        <div className="flex flex-col md:flex-row items-center gap-12">
          ...
          <div className="md:w-1/2">
            <div className="relative h-[320px] w-full md:h-[450px] rounded-2xl overflow-hidden bg-gradient-to-br from-purple-50 to-white border border-purple-100 shadow-lg">
              ...
              <div className="absolute top-8 left-8 w-24 h-24 rounded-full bg-[#1b3cfe]/90 opacity-40"></div>
              <div className="absolute bottom-12 right-12 w-32 h-32 rounded-full bg-[#1b3cfe]/90 opacity-30"></div>
              ...
              <div className="absolute bottom-6 left-6 bg-white/90 backdrop-blur-sm p-4 rounded-xl shadow-lg border border-gray-100 transform hover:scale-105 transition-all duration-300">
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-full bg-gradient-to-br from-[#1b3cfe] to-[#1b3cfe]/90 flex items-center justify-center">
          ...
          <div className="md:w-1/2">
            <div className="space-y-6">
              <div>
                <span className="inline-block px-4 py-1 bg-[#1b3cfe]/90 text-white font-medium rounded-full text-sm mb-3">Why Choose Us</span>
                <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4 leading-tight">
                  We are the <span className="relative inline-block">
                    <span className="relative z-10">solution</span>
                    <span className="absolute bottom-1 left-0 w-full h-3 bg-[#1b3cfe]/90 rounded-md -z-0"></span>
              ...
              <ul className="space-y-5">
                <li className="flex items-start group">
                  <div className="flex-shrink-0 w-6 h-6 rounded-full bg-gradient-to-r from-[#1b3cfe] to-[#1b3cfe]/90 flex items-center justify-center mt-1 group-hover:scale-110 transition-transform duration-300">
              ...
              <Link 
                href="/about" 
                className="inline-flex items-center gap-2 bg-gradient-to-r from-[#1b3cfe] to-[#1b3cfe]/90 text-white px-6 py-3 rounded-full font-medium hover:shadow-lg hover:translate-y-[-2px] transition-all duration-300"
              >
                Learn More
